    ...
    publicWidget.registry.AvanzoscRoot = publicWidget.Widget.extend({
        ...
        start: function () {
            ...
            if (window.matchMedia('(prefers-reduced-motion: reduce)').matches) {
                ...
                // ----------------------------------------------------------------
                // GSAP ScrollTrigger ↔ Lenis bridge (Pieza E).
                ...
                //      triggers creados por widgets (timeline.js Pieza E) usan
                ...
                //
                // Gating: este bloque se ejecuta sólo si Lenis está activo
                // (estamos dentro del else if Lenis del bloque superior). Si
                // reduced-motion o Lenis CDN unavailable, ScrollTrigger no se
                // configura aquí y los widgets gating mobile/reduced-motion no
                // crean pinned triggers.
                //
                // ScrollTrigger CDN puede no estar cargado (regresión en
                // assets.xml o ad-blocker); guard explícito.
                // ----------------------------------------------------------------
