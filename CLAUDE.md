...
- [ ] **Diferido — Timeline scroll-jacking (post-revert D28)** — 5 sprints, bug visual «ghost» por física. Original restaurado. NO bloquea switchover. [link](docs/decisions-log.md#deferred-timeline-scrolljacking).
